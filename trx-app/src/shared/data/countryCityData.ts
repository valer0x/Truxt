...
export const COUNTRIES: CountryData[] = [
  ...
  { code: "BR", name: "Brazil", cities: ["Sao Paulo", "Rio de Janeiro", "Brasilia"] },
  { code: "AR", name: "Argentina", cities: ["Buenos Aires", "Cordoba", "Rosario"] },
  { code: "CO", name: "Colombia", cities: ["Bogota", "Medellin", "Cali"] },
  { code: "CL", name: "Chile", cities: ["Santiago", "Valparaiso", "Concepcion"] },
...
export function getCitiesForCountry(countryName: string): string[] {
  ...
  const country = COUNTRIES.find(
    (candidate) => candidate.name.toLowerCase() === normalized || candidate.code.toLowerCase() === normalized
  );
